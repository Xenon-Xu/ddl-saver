...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ddlTableWidget.setColumnCount(7)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.ddlTableWidget.setHorizontalHeaderItem(6, item)
        self.ddlTableWidget.horizontalHeader().setCascadingSectionResizes(True)
        self.ddlTableWidget.horizontalHeader().setDefaultSectionSize(125)
        ...
        self.gridLayout_3.addWidget(self.setPushButton, 3, 1, 1, 1)
        self.completePushButton = QtWidgets.QPushButton(self.ctrlGroupBox)
        self.completePushButton.setEnabled(False)
        self.completePushButton.setObjectName("completePushButton")
        self.gridLayout_3.addWidget(self.completePushButton, 3, 2, 1, 1)
        ...
        self.completePushButton.clicked.connect(MainWindow.alterCompleteAction)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.ddlTableWidget.horizontalHeaderItem(6)
        ...
        self.completePushButton.setText(_translate("MainWindow", "标记为已完成"))
